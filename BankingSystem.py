customerNames = ['Amit Narwal', 'param khurana', 'Akash jain', 'Parth Dhakan', 'Akshat Limbachiya']
...
while True:
    print("=====================================")
    print(" ---- Welcome to Bank Application created by Amit Mandaliya ----       ")
    print("*************************************")
    ...
    if choiceNumber == "1":
       # Create account details:-
                ...
                pin = str(input("Please input a pin for your account : "))
